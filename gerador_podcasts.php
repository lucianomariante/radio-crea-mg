...
$url_radio = stripslashes($row_radio_dados['url_radio']);
...
echo "<br><br>".$url_radio."/xml_radioweb.php?id=".$row_listacategorias['id']."&editoria=".$row_listacategorias['editoria']."&autor=".$row_listacategorias['autor']."&area=".$row_listacategorias['area']."&cliente=".$row_listacategorias['cliente']."<br><br>";
	
	
try {
    $xml=simplexml_load_file_caseiro($url_radio."/xml_radioweb.php?id=".$row_listacategorias['id']."&editoria=".$row_listacategorias['editoria']."&autor=".$row_listacategorias['autor']."&area=".$row_listacategorias['area']."&cliente=".$row_listacategorias['cliente']."");
} catch (Exception $e) {
...
$xml=simplexml_load_file_caseiro($url_radio."/xml_radioweb_apagar.php") or die("Error: Cannot create object");
