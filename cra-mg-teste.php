...
<body data-rsssl=1 class="page-template page-template-elementor_canvas page page-id-697 wp-custom-logo elementor-default elementor-template-canvas elementor-kit-611 elementor-page elementor-page-697" onload="atualizavolume(); musica_passando(); musica_passara();">
	...
	<div data-elementor-type="wp-page" data-elementor-id="697" class="elementor elementor-697">
        ...
        <div class="container">
        <div class="row">
            <div class="col-6 text-center"><img src="img/logo-radiocramg.png" width="60%" alt=""/></div>
            <div class="col-6 text-center"><img src="img/logo-cramgok.png" width="60%"  alt=""/></div>    
        </div>
        </div>
        ...
        <div class="container" style="position: relative; z-index: 9999; margin-top: -80px">
            ...
            <div class="row padding-radio" style="border-radius: 25px; background-color: transparent; background-image: linear-gradient(90deg,#0F449B 0%,#0E87BA 100%);">
                        ...
                        <div class="col-md-3 col-6">
                            ...
                            <div style="z-index: 99999;
                                ...
                                margin: 21px 0px 0px -25px;" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="34" aria-valuetext="">
                                </div>
                        ...
                        <div class="col-md-3 col-6 m-radio">
                        ...
                        <div class="" data-id="2c3bf34" data-element_type="container" data-settings="{&quot;content_width&quot;:&quot;full&quot;}">
							<div class="" data-id="5c9c974" data-element_type="widget" data-widget_type="heading.default">
								<div class="" style="color: white !important; padding-left: 10px">
	...
	<div class="container-fluid" style="background-color: transparent; background-image: linear-gradient(90deg,#0F449B 0%,#0E87BA 100%) !important;" data-id="f152933" data-element_type="container">
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="elementor-widget-container">
                    <div class="texto-rodape">
                        <p style="color: white">Conselho Regional de Administração de Minas Gerais </p>
                        <p style="color: white">Endereço: Av. Olegário Maciel, 1233 – Lourdes</p>
                        <p style="color: white">Belo Horizonte-MG - CEP: 30180-111</p>
                        <p style="color: white">Telefone: (31) 3218-4500</p>
                    </div> 
                </div>
            </div>
            ...
            <div class="col-md-4 m-radio">
                

                <div class="row">
                
                <div class="col-2"></div>    
                <div class="col-2"><a href="#"><img src="img/facebook-icon.svg" alt=""/></a></div>
                <div class="col-2"><a href="#"><img src="img/instagram-icon.svg" alt=""/></a></div>
                <div class="col-2"><a href="#"><img src="img/linkedin-icon.svg" alt=""/></a></div>
                <div class="col-2"><a href="#"><img src="img/youtube-icon.svg" alt=""/></a></div>
                 <div class="col-2"></div>  
