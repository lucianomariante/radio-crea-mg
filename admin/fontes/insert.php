...
$query_registro = "SELECT * FROM radio_noticias WHERE id = '".$_POST['voltar']."'";
...
$query = "insert into radio_fontes (nome, cargo, email, idmateria, idmateriarw) values ('".$nome."', '".$cargo."', '".$email."', '".$idcategoria."', '".$idmateriarw."')";
