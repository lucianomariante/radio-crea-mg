...
<table align="center" class="lista">
  <tbody>
    <tr>
      <td colspan="11">Not&iacute;cias</td>
    </tr>
    <tr>
      <td colspan="11"><a href="insertform.php">Cadastrar Not&iacute;cia</a></td>
    </tr>
	...
	?>
      ...
      <td width="1%" class="alterar"><a href="../fontes/index.php?id=<? echo stripslashes($row_noticias['id']); echo $enxerto2; ?>">F</a></td>
	...
	<? } while ($row_noticias = mysqli_fetch_assoc($noticias)); ?>
      <tr>
        <td colspan="12" class="contador">Mat&eacute;rias <?php echo ($startRow_noticias + 1) ?> a <?php echo min($startRow_noticias + $maxRows_noticias, $totalRows_noticias) ?> de <?php echo $totalRows_noticias ?></td>
      </tr>
      <tr>
    ...
    <? } else { ?>
      <tr>
          <td colspan="12">N&atilde;o h&aacute; registros nessa &aacute;rea</td>
      </tr>
    <? } ?>
  </tbody>
</table>
