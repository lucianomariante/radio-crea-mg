...
$query = "insert into radio_noticias (data,	duracao, idcategoria, manchete, descricao, audio, url, autor, iddrive, ultima_atualizacao, thumbnail, data_lanc, amigavel, altimg, metakeywords) values ('".$data."', '".$duracao."', '".$idcategoria."', '".$manchete."', '".$descricao."', '".$audio."', '".$url."', '".$autor."', '".$iddrive."', '".time()."', '".$thumbnail."', '".$data_lanc."', '".$amigavel."', '".$altimg."', '".$metakeywords."')";
