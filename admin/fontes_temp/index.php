...
if($_GET['id']!="") { $enxerto = " radio_fontes_temp.idmateria = ".$_GET['id']; 
...
$query_noticias = "SELECT * FROM radio_fontes_temp where $enxerto order by nome DESC";
...
if (isset($_GET['totalRows_noticias'])) {
  ...
  $query_noticiasCount = "SELECT count(*) as total FROM radio_fontes_temp where $enxerto order by nome DESC";
