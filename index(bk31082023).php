    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <h2 style="font-size: 45px" class="py-5">O que voc&ecirc; quer ouvir hoje?</h2>
          ...
          <li class="nav-item"><a href="" data-target="#aba_series" data-toggle="tab" class="nav-link small text-uppercase">S&#233;ries</a></li>
          <li class="nav-item"><a href="" data-target="#aba_arquivos" data-toggle="tab" class="nav-link small text-uppercase">Arquivos</a></li>  
        ...
        <div id="aba_podcasts" class="tab-pane active">
			...
			<?php
			mysqli_select_db($conectar,$database_conectar);
			$query_materiaslistac = "SELECT radio_noticias.*, radio_podcasts.nome_podcast FROM radio_noticias, radio_podcasts where radio_noticias.idcategoria = radio_podcasts.id and radio_noticias.idcategoria = '3' and (radio_podcasts.destaque = 0 or radio_podcasts.destaque is Null) order by data desc,  radio_noticias.idradioweb DESC, radio_noticias.id DESC limit 6";
              ...
              <div class="col-md-4">
                <div class="thumbnail"> <img src="http://www.wowthemes.net/demo/calypso/img/demo/team1.jpg" alt="">
                  <div class="caption"> 
                    ...
                    <span class="primarycol"><?php echo formata_data($row_materiaslistac['data']); ?></span>
                    <p><?php echo stripslashes($row_materiaslistac['manchete']); ?></p>
                    <ul class="social-icons">
                      <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-play-circle"></i></a></li>
                        <li><a href="#"><i class="fa fa-download"></i></a></li>
          ...
          <div id="aba_noticias" class="tab-pane">
			...
			<?php
			mysqli_select_db($conectar,$database_conectar);
			$query_materiaslistac = "SELECT radio_noticias.*, radio_podcasts.nome_podcast FROM radio_noticias, radio_podcasts where radio_noticias.idcategoria = radio_podcasts.id and radio_noticias.idcategoria = '2' order by data desc, radio_noticias.idradioweb DESC, radio_noticias.id DESC limit 6";			
			$query_limit_materiaslistac = sprintf("%s LIMIT %d, %d", $query_materiaslistac, $startRow_materiaslistac, $maxRows_materiaslistac);
			$materiaslistac = mysqli_query($conectar,$query_materiaslistac);
			$row_materiaslistac = mysqli_fetch_assoc($materiaslistac);
			do { ?>  
