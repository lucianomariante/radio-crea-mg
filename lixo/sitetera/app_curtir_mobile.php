...
$url_whats = "whatsapp://send?text=Ouça esta matéria da Rádio TJMG : http://radiotjminas.com.br/not/".$_GET['id'];
...
//$url_twitter = "https://twitter.com/intent/tweet?text=OuÃ§a esta matÃ©ria da RÃ¡dio TJMG&url=".$vURL;
