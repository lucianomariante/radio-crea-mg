  ...
  <div class="card card-body">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <h2 style="font-size: 45px" class="py-5">O que você quer ouvir hoje?</h2>
          ...
          <li class="nav-item"><a href="" data-target="#aba_adm_em_foco" data-toggle="tab" class="nav-link small text-uppercase">Séries</a></li>
